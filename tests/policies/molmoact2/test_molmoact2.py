...
def test_molmoact2_from_pretrained_supports_original_hf_checkpoint(monkeypatch):
    def fake_apply_norm_tag_metadata(self):
        self.chunk_size = 10
        self.n_action_steps = 10
        self.input_features[OBS_STATE] = PolicyFeature(type=FeatureType.STATE, shape=(9,))
        self.input_features[f"{OBS_IMAGES}.image"] = PolicyFeature(
    ...
    monkeypatch.setattr(MolmoAct2Config, "apply_norm_tag_metadata", fake_apply_norm_tag_metadata)
